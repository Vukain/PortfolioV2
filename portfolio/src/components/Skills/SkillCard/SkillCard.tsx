    ...
    return (
        <article className={styles.card}>
            ...
            <div className={styles[`frontside_${category}`]}>
                ...
                <h2 className={styles[`title_${category}`]}>{category === 'graphics' ? 'grafika' : category}</h2>
            </div>

            <div className={styles[`backside_${category}`]}>
                <div className={styles.skew_wrapper}>
                    <h2 className={`${styles[`title_${category}`]} ${styles.title_skewed}`}>{category === 'graphics' ? 'grafika' : category}</h2>
