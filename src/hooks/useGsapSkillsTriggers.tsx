...
type CardRefs = { frontendRef: React.MutableRefObject<null | HTMLElement>, backendRef: React.MutableRefObject<null | HTMLElement>, graphicsRef: React.MutableRefObject<null | HTMLElement> };

export const useGsapSkillsTriggers = ({ frontendRef, backendRef, graphicsRef }: CardRefs, setActiveCard: React.Dispatch<React.SetStateAction<string>>) => {
